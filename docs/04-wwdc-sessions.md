# WWDC sessions (foundation + anchoring)

Curated sessions tied to placing and anchoring 3D content.
...
## RealityKit + ARKit foundations

- [Building Apps with RealityKit — WWDC19](https://developer.apple.com/videos/play/wwdc2019/605/) — plane `AnchorEntity`, USDZ/Reality, **meters**
...
Search Apple’s video catalog for “Work with Reality Composer Pro content in Xcode” for packaging workflows that change with Xcode releases.
